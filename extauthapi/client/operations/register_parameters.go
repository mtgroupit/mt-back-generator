...
// WithArgs adds the args to the register params
func (o *RegisterParams) WithArgs(args RegisterBody) *RegisterParams {
	o.SetArgs(args)
	return o
}

// SetArgs adds the args to the register params
func (o *RegisterParams) SetArgs(args RegisterBody) {
	o.Args = args
}
