...
// WithArgs adds the args to the change password params
func (o *ChangePasswordParams) WithArgs(args ChangePasswordBody) *ChangePasswordParams {
	o.SetArgs(args)
	return o
}

// SetArgs adds the args to the change password params
func (o *ChangePasswordParams) SetArgs(args ChangePasswordBody) {
	o.Args = args
}
